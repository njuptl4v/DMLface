...
if __name__ == "__main__":
    ...
    #   获得训练用的人脸标签与坐标
    #--------------------------------#
    training_dataset_path = '/home/featurize/work/retinafacefuben/retinaface-pytorch-master/data/data/widerface/train/label.txt'
    #-------------------------------#
    #   主干特征提取网络的选择
    #   mobilenet或者resnet50
    #-------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path  = "work/retinaface-pytorch-master/retinaface-pytorch-master/model_data/Retinaface_mobilenet0.25.pth"
    ...
    if not pretrained:
        weights_init(model)
    if model_path != 'work/retinaface-pytorch-master/retinaface-pytorch-master/model_data/Retinaface_mobilenet0.25.pth':
        #------------------------------------------------------#
        #   权值文件请看README，百度网盘下载
        #------------------------------------------------------#
