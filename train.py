...
if __name__ == "__main__":
    ...
    #   获得训练用的人脸标签与坐标
    #--------------------------------#
    training_dataset_path = '/home/featurize/work/sppflska/data/widerface/train/label.txt'#修改成自己训练以后权值的绝对路径
    #-------------------------------#
    #   主干特征提取网络的选择
    #   mobilenet或者resnet50
    #-------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path  = "/home/featurize/work/sppflska/model_data/Retinaface_mobilenet0.25.pth"#同上，修改路径
    ...
    if not pretrained:
        weights_init(model)
    if model_path != '/home/featurize/work/sppflska/model_data/Retinaface_mobilenet0.25.pth':
        #------------------------------------------------------#
        #   权值文件请看README，百度网盘下载
        #------------------------------------------------------#
